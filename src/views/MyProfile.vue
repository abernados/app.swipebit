                        ...
                        <div class="max-w-4xl mx-auto">
                            <div class=" overflow-hidden text-left">
                                ...
                                <div class="px-4 py-3 sm:px-6"
                                    ...
                                    <h3 class="text-md"
                                        :class="{
                                            'font-bold text-blue-dark': $route.matched.some(({ name }) => name === 'ProfilePicture.View'),
                                            'font-medium text-gray-900': !$route.matched.some(({ name }) => name === 'ProfilePicture.View'),
                                        }">
                                        <router-link to="/profile/picture">Profile Picture</router-link>
